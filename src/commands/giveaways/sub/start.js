...
module.exports = async (member, giveawayChannel, duration, prize, winners, host, allowedRoles = []) => {
  try {
    ...
    const options = {
      ...
      messages: {
        giveaway: "<:present:1383355329705676802> **GIVEAWAY** <:present:1383355329705676802>",
        giveawayEnded: "<:present:1383355329705676802> **GIVEAWAY ENDED** <:present:1383355329705676802>",
