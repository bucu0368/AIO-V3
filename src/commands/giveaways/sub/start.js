...
module.exports = async (member, giveawayChannel, duration, prize, winners, host, allowedRoles = []) => {
  try {
    ...
    const options = {
      ...
      messages: {
        giveaway: "<a:Giveaways:1351861871690645505> **GIVEAWAY** <a:Giveaways:1351861871690645505>",
        giveawayEnded: "<a:Giveaways:1351861871690645505> **GIVEAWAY ENDED** <a:Giveaways:1351861871690645505>",
        inviteToParticipate: "React with <:present:1383355329705676802> to enter",
        dropMessage: "Be the first to react with <:present:1383355329705676802>> to win!",
