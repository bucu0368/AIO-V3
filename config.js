module.exports = {
  OWNER_IDS: ["1142053791781355561"], // Bot owner ID's
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "1380608453067935864", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  EMBED_COLORS: {
    BOT_EMBED: "#068ADD",
    TRANSPARENT: "#36393F",
  ...
  GIVEAWAYS: {
    ENABLED: true,
    REACTION: "<:present:1383355329705676802>",
    START_EMBED: "#FF468A",
    END_EMBED: "#FF468A",
  },
